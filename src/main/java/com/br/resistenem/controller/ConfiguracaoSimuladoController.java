...
public class ConfiguracaoSimuladoController {
	...
	public String insertConfigSimulado(ConfiguracaoSimulado configuracaoSimulado, RedirectAttributes attibutes, HttpSession session) {
		...
		ConfiguracaoSimulado conf = csr.findAllByDificuldadesAndTipoSimuladoAndMateria(configuracaoSimulado.getDificuldades(),configuracaoSimulado.getTipoSimulado(),configuracaoSimulado.getMateria());
		...
		Materia materias = mr.findMateriaById(configuracaoSimulado.getMateria().getId());
		configuracaoSimulado.setMateria(materias);
	...
	public String updateConfigSimulado(ConfiguracaoSimulado configSimulado, RedirectAttributes attibutes, HttpSession session) {
		...
		Materia materia =  mr.findMateriaById(configSimulado.getMateria().getId());
		...
		configSimulado.setMateria(materia);
